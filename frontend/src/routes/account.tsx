...
function AccountPage() {
    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            {errorMsg && (
                <div
                    className="mb-6 flex items-start gap-3 rounded-lg border border-destructive/20 bg-destructive/10 p-4 text-destructive animate-fade-in">
            ...
            {successMsg && (
                <div
                    className="mb-6 flex items-start gap-3 rounded-lg border border-emerald-500/20 bg-emerald-500/10 p-4 text-emerald-600 dark:text-emerald-400 animate-fade-in">
...
function ProfilePhotoSection({
    ...
    return (
        <div className="flex flex-col items-center">
            <div className="w-full rounded-xl border border-border bg-card p-6 shadow-xs text-center">
                ...
                <div className="relative mx-auto h-32 w-32 group">
                    {displayPictureUrl ? (
                        ...
                        <div
                            className="flex h-32 w-32 items-center justify-center rounded-full bg-primary/10 text-primary border border-primary/20 text-3xl font-bold font-heading shadow-xs">
                    ...
                    {isUploading && (
                        <div
                            className="absolute inset-0 flex items-center justify-center rounded-full bg-background/80 text-primary">
            ...
            {/* Account Role Badge */}
            <div
                className="mt-4 w-full rounded-xl border border-border bg-card px-6 py-4 shadow-xs flex items-center justify-between">
                <span
                    className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Tipo de Conta</span>
...
function ProfessionalAccountSection({
    ...
    return (
        <div className="rounded-xl border border-border bg-card p-6 shadow-xs">
            ...
            {profile.isProfessional ? (
                <div
                    className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-primary/5 rounded-lg border border-primary/10 p-5">
                    <div
