        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfessionalId = table.Column<string>(type: "character varying(450)", maxLength: 450, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopInvites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopInvites_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShopProfessionals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShopProfessionals_Shops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "Shops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationQueue_Appointments_AppointmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ShopProfessionalId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfessionalSchedules_ShopProfessionals_ShopProfessionalId",
                        column: x => x.ShopProfessionalId,
                        principalTable: "ShopProfessionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ScheduleExceptions_ShopProfessionals_ShopProfessionalId",
                        column: x => x.ShopProfessionalId,
                        principalTable: "ShopProfessionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ImagePath = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    ShopProfessionalsId = table.Column<int>(type: "integer", nullable: false),
                    ShopProfessionalId = table.Column<int>(type: "integer", nullable: false),
                    CreatedBy = table.Column<string>(type: "text", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedBy = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_ShopProfessionals_ShopProfessionalId",
                        column: x => x.ShopProfessionalId,
                        principalTable: "ShopProfessionals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationQueue_AppointmentId",
                table: "NotificationQueue",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionalSchedules_ShopProfessionalId",
                table: "ProfessionalSchedules",
                column: "ShopProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_ScheduleExceptions_ShopProfessionalId",
                table: "ScheduleExceptions",
                column: "ShopProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_Services_ShopProfessionalId",
                table: "Services",
                column: "ShopProfessionalId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopInvites_ShopId",
                table: "ShopInvites",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_ShopProfessionals_ShopId",
                table: "ShopProfessionals",
                column: "ShopId");
        }
